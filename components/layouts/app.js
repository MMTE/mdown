...
export default function AppLayout(props) {
                                    ...
                                    <div class="m-auto md:w-8/12 lg:w-6/12 xl:w-6/12">
                                        <div class="rounded-xl bg-white shadow-xl">
                                            <div className='container mx-auto content-center items-center px-6 py-4'>
                                                <p className='text-xl'>این صفحه نیاز به لاگین دارد. ابتدا در سایت لاگین
                                                    کنید.</p>
 ...
 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                                                        <div
                                                            ...
                                                            <span
                                                                class="block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Continue with Github</span>
                                                        </div>
                                                    </button>
                                                </Link>
                                            </div>
